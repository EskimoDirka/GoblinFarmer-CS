...
- Added `Docs\ProjectBrain\README.md`, `Current_State.md`, `Goblin_Tracker.md`, `Routes_And_Areas.md`, `Debug_And_Testing.md`, `Release_And_Build.md`, and `Codex_Workflow.md` as compact topic summaries for AI-assisted context loading.
- Intended purpose: create a lightweight docs-only `GoblinFarmer_ProjectBrain_YYYYMMDD_HHMMSS.zip` package for AI-assisted development context without runtime/debug artifacts, while keeping this file as the source of truth.
...
- Included files are allowlisted only: `AGENTS.md`, `README.md`, `Docs\Project_Status.md`, `Docs\ProjectBrain\*.md`, selected small stable docs such as `Docs\TODO.md`, `Docs\History.md`, `Docs\CombatProfiles.md`, `Docs\TeleportLogic.md`, `Docs\ScanRegions.md`, `Docs\Release_Checklist.md`, `Docs\Release_v1.4.md`, and optional `Docs\Test_Results.md`, `Docs\Known_Issues.md`, `Docs\Next_Tasks.md`, and `Docs\Release_Notes.md` when they exist.
- The script creates `ProjectBrain` automatically, reports included and skipped files, and prints the final ZIP size and path.
- Script updated: `Scripts\create-project-brain.ps1` now dynamically includes every `Docs\ProjectBrain\*.md` file and selected small stable docs.
- Tested: script run created a timestamped ZIP under `ProjectBrain`, skipped missing optional docs without failing, included all Project Brain topic docs, and ZIP contents were verified as documentation-only with no build/debug/generated folders.
- Still needs testing: repeat from a clean checkout where optional docs may be added later.
- Next recommended task: use the generated Project Brain ZIP when handing current repository context to an AI assistant that does not need debug packages or runtime evidence, and update the topic summaries when `Docs\Project_Status.md` changes materially.
