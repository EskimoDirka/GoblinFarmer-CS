...
* [x] Replace Witch Doctor held/channel behavior with mouse-wheel scrolling plus discrete cursor-change left-click pulses while preserving the `2,3,1` key loop and no-click safety logs.
