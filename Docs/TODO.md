...
- [ ] Post-fix live-validate Stinging Winds: any fresh Stinging Winds goblin should auto-count from Minimap/Journal evidence even if an old same-type Journal row from the previous area is still visible; after leaving, the delayed Stinging Winds Journal row should not recount in Black Canyon Mines.
- [ ] Post-fix live-validate Rakkis Crossing: a visible Journal row from a Black Canyon Mines count should not recount after teleporting to Rakkis Crossing; a real fresh Rakkis goblin should still count from Minimap/Journal evidence.
...
- [ ] Live-validate Make New Game does not recount a previous-game visible Journal row after the reset; expected suppression log is `JournalCandidateIgnoredResetCarryover`.
