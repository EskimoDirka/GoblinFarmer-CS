...
- [ ] Confirm `GoblinFarmer.csproj` contains the intended `<Version>`, `<AssemblyVersion>`, `<FileVersion>`, and `<InformationalVersion>`.
- [ ] Run `powershell -NoProfile -ExecutionPolicy Bypass -File .\Scripts\publish-release.ps1`.
