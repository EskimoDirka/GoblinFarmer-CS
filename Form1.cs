...
namespace GoblinFarmer
{
    public partial class frmMain : Form
    {
        ...
        private void tmrStatus_Tick(object sender, EventArgs e)
        {
            ...
            PortUpdateGoblinOverlay(diabloRunning);
        ...
        private void PortRecordDiabloLaunchAfterBattleNet(long elapsedMs)
        {
            ...
            if (battleNetPlayClickSentByApp && !battleNetPlayClickAcceptedByBattleNet)
            {
                PortRecordBattleNetPlayClickAccepted("Diablo process detected after app Play click", elapsedMs);
            }
            ...
            else
            {
                ...
                string manualScreenshotPath = CaptureDebugScreenshot("BattleNetLaunch", "BattleNetManualPlaySuspected");
        ...
        private void PortLogBattleNetStillOpenAfterDiabloLaunch()
        {
            ...
            bool successfulAppClickLaunch = battleNetPlayClickAcceptedByBattleNet && diabloLaunchedAfterAppPlayClick;
