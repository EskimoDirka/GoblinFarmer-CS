...
Scope: GoblinFarmer refactor roadmap. This is a plan plus status tracker for low-risk extractions. It does not change runtime behavior, thresholds, routing, combat, repair, salvage, gem-stash, Kadala, make-new-game, replay execution, OBS behavior, or package output.
